...
const SubNavbar = () => {
  ...
  return (
      ...
      <div className="header-search w-2/3 h-12">
        <div className="search-form flex items-center rounded-lg bg-[#d2d2d2] p-5 h-12">
          ...
          <div className="search-form-in-category flex items-center">
            <div className="search-form-separator text-[#444444]">|</div>
            <div className="search-form-dropdown">
              <select
                className="focus: bg-[#d2d2d2] px-3 outline-none"
