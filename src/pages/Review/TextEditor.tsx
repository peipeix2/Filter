...
const TextEditor = () => {
    ...
    const resetMoviesReview = useMoviesReviewStore((state) => state.resetMoviesReview)

    const editor = useEditor({
        editorProps: {
            attributes: {
                class: 'border border-gray-400 p-4 min-h-[30rem] max-h-[30rem] overflow-y-auto outline-none',
            },
    ...
    return (
        <section className="text-editor-container mx-auto my-8 max-w-4xl">
            <div className="mb-3 w-full">
                <Input type="text" label="標題" labelPlacement="outside-left" value={moviesReview.title} onChange={(e) => setMoviesReview('title', e.target.value)} />
            </div>
                    ...
                    return (
                        <label key={index}>
                            <input
                                ...
                                value={ratingValue}
                                onClick={() =>
                                    setMoviesReview('rating', ratingValue)
                                }
                            />
                            <FaStar
                                size={30}
                                color={
                                    (ratingValue <= hover || moviesReview.rating) ? 'orange' : '#e4e5e9'
                                }
            ...
            <div className='tags-privacy mt-5 flex justify-between'>
                ...
                />
                <div className="flex justify-start px-1 py-2 items-center">
                    ...
                    <Checkbox
                        ...
                        onChange={(e) =>
                            setMoviesReview('isPublic', !e.target.checked)
                        }
                    >
                        不公開
                    </Checkbox>
